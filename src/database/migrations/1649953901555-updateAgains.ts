...
export class updateAgains1649953901555 implements MigrationInterface {
  name = 'updateAgains1649953901555';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "review" ("id" varchar PRIMARY KEY NOT NULL, "title" varchar NOT NULL, "rating" varchar NOT NULL, "trailerId" varchar, "content" varchar NOT NULL, CONSTRAINT "FK_48893c0ad32faf7bd0ea291f4e2" FOREIGN KEY ("trailerId") REFERENCES "trailer" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`,
    );
    await queryRunner.query(
      `INSERT INTO "review"("id", "title", "rating", "trailerId", "content") SELECT "id", "title", "rating", "trailerId", "content" FROM "temporary_review"`,
    );
    ...
    await queryRunner.query(`ALTER TABLE "actor" RENAME TO "temporary_actor"`);
    await queryRunner.query(
      `CREATE TABLE "actor" ("id" varchar PRIMARY KEY NOT NULL, "name" varchar NOT NULL, "dateOfBirth" datetime NOT NULL, "description" varchar NOT NULL, "trailerId" varchar, CONSTRAINT "FK_23ef419ba59aeacac4daa0536c3" FOREIGN KEY ("trailerId") REFERENCES "trailer" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`,
    );
    await queryRunner.query(
      `INSERT INTO "actor"("id", "name", "dateOfBirth", "description", "trailerId") SELECT "id", "name", "dateOfBirth", "description", "trailerId" FROM "temporary_actor"`,
    );
